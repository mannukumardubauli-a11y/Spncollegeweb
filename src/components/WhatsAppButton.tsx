...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <span className="absolute right-full mr-4 bg-white text-emerald-950 px-4 py-2 rounded-xl text-sm font-bold opacity-0 group-hover:opacity-100 transition-opacity shadow-xl whitespace-nowrap pointer-events-none">
        {t('whatsapp.cta')}
      </span>
    </motion.a>
  );
