...
const translations = {
  hi: {
    ...
    'footer.newsletterDesc': 'नवीनतम अपडेट और सूचनाएं प्राप्त करने के लिए सब्सक्राइब करें।',
  ...
  en: {
    ...
    'footer.newsletterDesc': 'Subscribe to get the latest updates and notifications.',
